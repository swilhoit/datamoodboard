-- App settings for configurable limits
...
-- Optional seed values for generous early-stage limits (adjust as needed)
...
-- Update limit functions to respect app_settings overrides
